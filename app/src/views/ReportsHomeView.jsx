...
const REPORT_CARDS = [
  {
    ...
    eyebrow: "Leaderboard report",
    description: "A compact leaderboard with win probability, title path health, and current pool positioning.",
  },
  {
    to: "/reports/leverage",
    title: "Leverage Report",
    eyebrow: "Decision pressure",
    description: "Spot the games and teams most likely to swing the race from here.",
  },
  {
    to: "/reports/rooting",
