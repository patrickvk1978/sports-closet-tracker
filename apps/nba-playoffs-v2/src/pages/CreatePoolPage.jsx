      ...
      <div className="panel">
        ...
        <form onSubmit={handleCreate} className="form-stack">
          ...
          <div className="detail-card spotlight">
            ...
            <p>Rank the final 16 playoff teams from 16 down to 1. Every series win scores team value plus round and dominance bonuses, so the whole postseason becomes a live portfolio.</p>
          </div>
