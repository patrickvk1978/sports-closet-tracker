...
function parseTodayGame(event) {
  ...
  return {
    ...
    homeAbbreviation,
    awayAbbreviation,
    homeTeamName: home.team?.displayName ?? home.team?.name ?? homeAbbreviation,
    awayTeamName: away.team?.displayName ?? away.team?.name ?? awayAbbreviation,
    homeTeamLogo: home.team?.logo ?? home.team?.logos?.[0]?.href ?? null,
    awayTeamLogo: away.team?.logo ?? away.team?.logos?.[0]?.href ?? null,
